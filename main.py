...
def workout():
    ...
    print("A reminder that today is: " + datetime.today().strftime("%A") +
          ". Consider option " +
        ...
        if activity.lower() == "list":
            if select == "abs":
                for i in range(len(abs)):
                    print(
                        str(i + 1) + ". " + str(abs[i]) + "\t 2 Sets of " +
                        str(abs_count[i]) + " Reps")
            elif select == "quads":
                for i in range(len(quads)):
                    print(
                        str(i + 1) + ". " + str(quads[i]) + "\t 2 Sets of " +
                        str(quads_count[i]) + " Reps")
            elif select == "glutes":
                for i in range(len(glutes)):
                    print(
                        str(i + 1) + ". " + str(glutes[i]) + "\t 2 Sets of " +
                        str(glutes_count[i]) + " Reps")
            elif select == "triceps":
                for i in range(len(glutes)):
                    print(
                        str(i + 1) + ". " + str(triceps[i]) + "\t 2 Sets of " +
                        str(triceps_count[i]) + " Reps")
            elif select == "biceps":
                for i in range(len(biceps)):
                    print(
                        str(i + 1) + ". " + str(biceps[i]) + "\t 2 Sets of " +
                        str(biceps_count[i]) + " Reps")
            elif select == "back":
                for i in range(len(back)):
                    print(
                        str(i + 1) + ". " + str(back[i]) + "\t 2 Sets of " +
                        str(back_count[i]) + " Reps")
            elif select == "chest":
                for i in range(len(chest)):
                    print(
                        str(i + 1) + ". " + str(chest[i]) + "\t 2 Sets of " +
                        str(chest_count[i]) + " Reps")
            print("")
            run_activity = True
            ...
            if select == "abs":
                ...
                print("Please complete 2 Sets of " +
                      str(abs_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(quads_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(glutes_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(triceps_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(biceps_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(back_count[activity_num]) + " Reps of " +
                ...
                print("Please complete 2 Sets of " +
                      str(chest_count[activity_num]) + " Reps of " +
            ...
            try:
                ...
                if select == "abs":
                    ...
                    for i in range(len(glutes) - len(complete)):
                        print(
                            str(i + 1) + ". " + str(glutes[i + activity_num]))
                elif select == "triceps":
                    for i in range(len(triceps) - len(complete)):
                        print(
                            str(i + 1) + ". " + str(triceps[i + activity_num]))
                elif select == "biceps":
                    for i in range(len(biceps) - len(complete)):
                        print(
                            str(i + 1) + ". " + str(biceps[i + activity_num]))
                elif select == "back":
            ...
            print(
                "Sorry that is not an option. Please see this list of options below:"
            )
            print("list    Lists the workout activities by muscle group.")
            print(
                "start   Starts the workout and displays the first workout activity."
